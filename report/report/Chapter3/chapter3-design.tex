...
\item Processing: Edge-based inference using embedded systems (Raspberry Pi)
...
Decision Trees are selected as the primary model due to their low computational complexity, fast inference suitable for real-time applications, and high interpretability.
